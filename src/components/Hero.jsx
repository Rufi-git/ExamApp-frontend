...
const Hero = () => {
    return (
        <div className="bg-gradient-to-t from-[#1084da] to-[#10c6a8] pt-[60px] pb-[200px]">
            <div className="text-white px-4 max-w-[1440px] mx-auto">
                ...
                <div className="mt-10 text-center justify-center flex">
                    <Link to="/" className="text-[#373737] rounded-md px-6 py-2 bg-gradient-to-t from-[#f19a1a] to-[#ffc73c]">
